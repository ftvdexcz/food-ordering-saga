...
import com.food.ordering.system.domain.valo.OrderApprovalStatus;
...
public class OrderMessagingDataMapper {
    public PaymentRequestAvroModel orderCreatedEventToPaymentRequestArvoModel(OrderCreatedEvent orderCreatedEvent){
    ...
    public PaymentRequestAvroModel orderCancelledEventToPaymentRequestArvoModel(OrderCancelledEvent orderCancelledEvent){
